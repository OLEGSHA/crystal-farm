...
public class SettingRWColor extends SettingRW<Color> {
	
	public SettingRWColor() {
		super("Inbuilt-Color",
				Color.class,
				
				declar -> {
					if (declar.equals("RANDOM")) {
						return new RandomColor();
					} else {
						try {
							return Color.parse(declar);
						} catch (IllegalArgumentException e) {
							throw new ConfigurationSyntaxException("\"" + declar + "\" does not denote a correct color", e);
						}
					}
				},
